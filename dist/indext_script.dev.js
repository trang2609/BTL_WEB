...
function themvaogiohang(x) {
  ...
  showcountsp(); //lưu giỏ hàng lên sesionStorage 
...
setTimeout(function () {
  ...
  document.getElementById('overlay').style.display = 'block'; // Đóng popup sau 10 giây
...
var picker = new EmojiButton(); // Chọn emoji  
...
submitBtn.addEventListener('click', function () {
  var userInput = inputElm.value;
  var temp = "<div class=\"out-msg\">\n    <span class=\"my-msg\">".concat(userInput, "</span>\n    <img src=\"images/logo/kiyeu.jpg\" class=\"avatar\">\n    </div>");
...
/*----------------Nút quay lại đầu trang--------------*/
//# sourceMappingURL=indext_script.dev.js.map
